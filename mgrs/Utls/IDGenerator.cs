...
namespace Utls
{
    public class IDGenerator
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetIdW()
        {
            int n = rd.Next(99);
            return string.Format("W{0}{1}", DateTime.Now.Ticks, n.ToString().PadLeft(2, '0'));
        }

        public static string GetIdC()
        {
            int n = rd.Next(99);
            return string.Format("C{0}{1}", DateTime.Now.Ticks, n.ToString().PadLeft(2, '0'));
        }
    }
}

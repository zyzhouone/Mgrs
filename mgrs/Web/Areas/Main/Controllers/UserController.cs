...
namespace Web.Areas.main.Controllers
{
    public class UserController : BaseController
    {
        ...
        public ActionResult LogQuery(string name, string tel, int? pageIndex)
        {
            var bll = new UserBll();
            var logs = bll.GetLogs(name, tel, pageIndex.GetValueOrDefault(1));
            List<SelectListItem> Opttype = new MemberBll().GetDict(15);
            ViewData["Opttype"] = Opttype;
            List<SelectListItem> Source = new MemberBll().GetDict(16);
